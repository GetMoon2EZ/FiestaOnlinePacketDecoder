...
const std::map<const char *, const char *, cmp_str> tr_map_names_fr {
    ...
    { "BFGate01", "Perimetre forestier" },
    { "BFGate02", "Perimetre forestier" },
    ...
    /* Added manually */
    { "S_Tower0100", "Tour spirale du sacrifice (20-85)" },
    { "S_Tower0200", "Tour spirale de la vangence (86-125)" },
